...
{
private:
	// Index of the most recently viewed account set when opening an account and viewing an account with index
...
public:
	...
	// valid money amount, and assigns the valid pound and pence amount by reference to the first 2 parameters
